 ...
 * tags:
 *   name: Individuals
 *   description: Individual management and retrieval
 */
 ...
 *     description: Only admins can create other individuals.
 *     tags: [Individuals]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Only admins can retrieve all individuals.
 *     tags: [Individuals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of individuals
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 *     description: Logged in individuals can fetch only their own individual information. Only admins can fetch other individuals.
 *     tags: [Individuals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in individuals can only update their own information. Only admins can update other individuals.
 *     tags: [Individuals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in individuals can delete only themselves. Only admins can delete other individuals.
 *     tags: [Individuals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
